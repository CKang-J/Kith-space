...
| 30 | Agent Harness v2 | per-surface session + durable delivery/logical turn/attempt + Context Envelope + revisioned episodic memory + broker-backed MCP/CLI Gateway；P-A10.0–P-A10.2 已完成，P-A10.3–P-A10.7 实施中 |
...
**状态**：Accepted / Implementing。P-A10.0–P-A10.2 已完成迁移、schema v6、Runtime v2 bridge、per-surface registry、broker 与 durable turn 纵切；P-A10.3 Context Envelope、schema v7 memory 和管理 UI 尚未实施。
