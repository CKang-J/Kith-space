...
完整模块契约、数据模型、UI island、Prompt/Skill 适配、5个开发阶段、失败模式和验收矩阵见 `../superpowers/specs/2026-08-15-recombyn-canvas-workspace-design.md`；决策摘要见 `../adr/0038-adopt-recombyn-canvas-module.md`。
