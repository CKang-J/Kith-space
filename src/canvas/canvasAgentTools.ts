...
export const CANVAS_TYPED_TOOL_DESCRIPTIONS = {
  "canvas.scene_summary": "Read a grant-scoped, model-friendly Canvas summary (canvasId, snapshotId, revision, selected Frames, element abstracts, allowedCreateParents). Call this before creating or editing. Do not inspect project source to learn Canvas. 画布摘要/先读再改",
