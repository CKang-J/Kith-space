...
**进度以 `docs/progress.md` 为权威来源**（本段不重复，避免漂移）。截至 2026-07-18：A2-A6、P-A7 H1-H4、P4/P-A8、本轮聊天与壳层 UI，以及 P-A9.0–P-A9.7 的实现和最终门禁均已完成；P-A9 已提交，真实存量数据暴露的 Runtime admission 队列饥饿、queued 假工作态与失败 wake 残留回复占位也已修复。H5 与 Runtime 契约 v2 均未开始。做到哪、下一步与关键发行边界全部见 `docs/progress.md`。
