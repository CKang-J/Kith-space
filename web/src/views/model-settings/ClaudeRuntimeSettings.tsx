...
import { CLAUDE_PROVIDER_PRESETS } from "../../data/claudeProviderPresets";
  ...
  const handleImportConfig = async () => {
    ...
    try {
      ...
      if (!preview.sourceMtimeDigest) {
        ...
        setErrorMessage("未找到 Claude Code 配置文件");
        return;
      }
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          ...
          <p style={{ margin: "0 0 12px", fontSize: "13px", color: "#5f6368", lineHeight: "1.5" }}>
            Claude Code 使用 TOML 配置文件（~/.config/claude/config.toml）。
            您可以导入现有配置，或使用下方预设创建新配置。
          </p>
          <button
            type="button"
