...
export const TerminalTitle = ({
  ...
  <div
    className={cn("flex items-center gap-2 text-[length:var(--font-size-meta)] text-muted-foreground", className)}
    {...props}
  >
...
export const TerminalContent = ({
  ...
  return (
    <div
      className={cn(
        "max-h-96 overflow-auto p-4 font-mono text-[length:var(--font-size-meta)] leading-relaxed",
        className
      )}
      ref={containerRef}
      {...props}
