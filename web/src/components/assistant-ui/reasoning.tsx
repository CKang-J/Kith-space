  ...
  if (side === "top") {
    return (
      <div
        ...
        "group-data-[variant=muted]/reasoning-root:bg-[linear-gradient(to_bottom,color-mix(in_oklch,var(--muted)_50%,transparent),transparent)]",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "group-data-[variant=muted]/reasoning-root:bg-[linear-gradient(to_top,color-mix(in_oklch,var(--muted)_50%,transparent),transparent)]",
        "fade-in-0 animate-in",
        "duration-(--animation-duration)",
        className,
      )}
...
function ReasoningTrigger({
  ...
  return (
    <CollapsibleTrigger
      ...
      className={cn(
        "aui-reasoning-trigger group/trigger flex max-w-[75%] appearance-none items-center gap-2 border-0 bg-transparent px-0 py-1.5 text-sm text-muted-foreground outline-none transition-[color,scale] hover:bg-transparent hover:text-foreground focus-visible:!outline-none focus-visible:text-foreground focus-visible:underline focus-visible:underline-offset-4 active:scale-[0.98]",
        className,
      )}
      {...props}
    >
