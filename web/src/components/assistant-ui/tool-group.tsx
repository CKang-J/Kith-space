...
function ToolGroupTrigger({
  ...
  return (
    <CollapsibleTrigger
      ...
      className={cn(
        "aui-tool-group-trigger group/trigger flex appearance-none items-center gap-2 border-0 bg-transparent px-0 text-sm outline-none transition-[color,scale] hover:bg-transparent focus-visible:!outline-none focus-visible:text-foreground focus-visible:underline focus-visible:underline-offset-4 active:scale-[0.98]",
